...
const Header = ({ 
  ...
  return (
    ...
    >
      {/* Mobile Header */}
      <motion.header 
        className={`w-full bg-white shadow px-4 py-3 flex items-center justify-between md:hidden ${
      ...
      {/* Desktop Header */}
      <motion.header 
        className={`w-full bg-white shadow px-6 py-3 items-center justify-between max-w-screen-xl mx-auto relative hidden md:flex ${
          isScrolled ? 'shadow-md py-2' : ''
        }`}
        initial="hidden"
        animate="visible"
